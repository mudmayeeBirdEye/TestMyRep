trigger BigWinsFormcStats on BigWins_Form__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('BigWins_Form__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
