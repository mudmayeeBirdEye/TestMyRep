trigger CustomerStorycStats on CustomerStory__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('CustomerStory__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
